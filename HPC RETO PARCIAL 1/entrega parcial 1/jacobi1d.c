 ...
 */
void jacobi(int nsweeps, int n, float* u, float* f)
{
    int i, sweep;
    float h  = 1.0 / n;
    float h2 = h*h;
    float* utmp = (float*) malloc( (n+1) * sizeof(float) );
...
void write_solution(int n, float* u, const char* fname)
{
    int i;
    float h = 1.0 / n;
